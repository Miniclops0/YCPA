...
tSim = 200e-15
f = 290e12; % frequency increased here
lambda = c_c/f;
...
epi{1} = ones(nx{1},ny{1})*c_eps_0;  % permitivity at all points
%epi{1}(125:150,55:95)= c_eps_0*11.3; % Inclusion
% additional inclusions
%epi{1}(25:15,5:15)= c_eps_0*11.3; 
epi{1}(15:30,10:95)= c_eps_0*11.3;
epi{1}(30:45,45:60)= c_eps_0*11.3;
epi{1}(45:60,10:95)= c_eps_0*11.3;
epi{1}(75:90,10:70)= c_eps_0*11.3;
epi{1}(75:90,80:95)= c_eps_0*11.3;
%epi{1}(133:147,10:75)= c_eps_0*11.3;
...
bc{1}.s(1).type = 'e';
bc{1}.s(1).fct = @PlaneWaveBC; % boundaries
% mag = -1/c_eta_0;
mag = 1;
phi = 0;
omega = f*2*pi;
